    ...
    private void initView() {
        ...
        main_bt_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                id++;
                //事件统计
                StatisticsHelper.getInstance().AddEvent(VideoActivity2.this,"event_play"+id,null);
        ...
        main_bt_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                idb++;
                //事件统计
                StatisticsHelper.getInstance().AddEvent(VideoActivity2.this,"event_pause"+idb,null);
                // 暂停播放
